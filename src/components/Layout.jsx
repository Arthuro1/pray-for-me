        ...
        <div className="flex items-center justify-between px-4 mb-8" style={{ minHeight: 32 }}>
          {!collapsed && (
            <div className="flex items-center gap-2.5 overflow-hidden">
              <img src="/logo-constellation.svg" alt="Praystead" className="w-8 h-8 rounded-lg shrink-0" />
              <span className="font-bold text-sm whitespace-nowrap" style={{ color: 'var(--text-1)' }}>Praystead</span>
            </div>
          )}
          {collapsed && <img src="/logo-constellation.svg" alt="Praystead" className="w-8 h-8 rounded-lg mx-auto" />}
      ...
      {!hasOwnMobileHeader && (
        ...
        >
          <div className="flex items-center gap-2">
            <img src="/logo-constellation.svg" alt="Praystead" className="w-7 h-7 rounded-lg" />
