...
const CONTENT = {
  fr: {
    ...
    features: [
      ...
      { icon: Lock, color: '#6d28d9', title: 'Privé & transparent', desc: 'Vos prières sont sécurisées — seul vous pouvez les voir. Les fonctionnalités IA envoient uniquement le titre de la prière pour générer des suggestions. Nous sommes transparents sur ce qui est partagé.' },
    ],
  ...
  en: {
    ...
    features: [
      ...
      { icon: Lock, color: '#6d28d9', title: 'Private & transparent', desc: 'Your prayers are stored with row-level security — only you can see them. AI features send only the prayer title to generate suggestions; we are transparent about what is shared.' },
    ],
