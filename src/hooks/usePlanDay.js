...
export function usePlanDay(planId, dayNumber, lang, { fallbackLanguages } = {}) {
  const day = useLocalizedPlanDay(planId, dayNumber, lang);
  const prefs = useMemo(() => (planId ? getPlanPrefs(planId) : null), [planId]);
