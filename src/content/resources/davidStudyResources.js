// Link verification and Paul's explicit 2026-09-03 editorial approval are
// recorded separately. The shared resolver still requires both gates.
...
export const DAVID_STUDY_RESOURCES = [
  {
    id: 'cdf-origins-monarchy-2026', type: 'study', originalLanguage: 'fr', status: 'approved', reviewLevel: 'sensitive',
  ...
  {
    id: 'jewish-museum-tel-dan', type: 'article', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
  ...
  {
    id: 'louvre-mesha-stele', type: 'article', originalLanguage: 'fr', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
    topics: ['biblical-archaeology', 'kingship'], lifeStages: [],
  ...
  {
    id: 'mesha-reading-hypothetical', type: 'article', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
  ...
  {
    id: 'mesha-reading-defence', type: 'article', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
    topics: ['biblical-archaeology'], lifeStages: [],
  ...
  {
    id: 'daahl-atlas', type: 'study', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
  ...
  {
    id: 'british-museum-philistine-pottery', type: 'article', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
  ...
  {
    id: 'iaa-qeiyafa-2013', type: 'article', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
  ...
  {
    id: 'tau-ancient-jerusalem', type: 'article', originalLanguage: 'en', status: 'approved',
    contentReview: { ...PAUL_RESOURCE_SIGNOFF },
    safetyReview: { ...PAUL_RESOURCE_SIGNOFF },
