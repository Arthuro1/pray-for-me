...
11. [`supabase/user_settings.sql`](./supabase/user_settings.sql) — account-level `user_settings` table (language, theme, AI consent + reminder prefs synced across browsers/devices)
